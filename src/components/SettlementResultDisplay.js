...
export default function SettlementResultDisplay() {
  const { processedData, resetSettlement, previousProcessedData, undoProcessing } = useSettlement();
  ...
  const handleDownloadExcel = () => {
    ...
    try {
      ...
      downloadExcel(processedData, fileName, totals, getProductDisplayName);
    } catch (error) {
      toast({
        title: "下载失败",

      ...
      <section className="bg-card rounded-lg shadow-sm border border-border p-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            <Button onClick={handleConvert} className="shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
              </svg>
              开始转换
            </Button>
            <Button onClick={handleClear} variant="outline" size="sm" className="shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <>
              <div className="pt-2">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Button onClick={handleCopyResults} variant="outline" size="sm" className="h-7 text-xs px-2 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
